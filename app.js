...
if (categorySubmitBtn) {
  categorySubmitBtn.onclick = (e) => { e.preventDefault(); window.handleCategorySubmit(); };
}
if (categoryCancelBtn) {
  categoryCancelBtn.onclick = (e) => { e.preventDefault(); window.clearCategoryForm(); };
}
...
if (widgetSubmitBtn) {
  widgetSubmitBtn.onclick = (e) => { e.preventDefault(); window.handleWidgetUpdate(); };
}
...
if (submitBtn) {
  submitBtn.onclick = (e) => { e.preventDefault(); window.handleProductSubmit(); };
}
...
const specialGroupOrderBtn = document.getElementById("specialGroupOrderBtn");
if (specialGroupOrderBtn) {
  specialGroupOrderBtn.onclick = (e) => { e.preventDefault(); window.saveSpecialGroupOrdersManually(); };
}
